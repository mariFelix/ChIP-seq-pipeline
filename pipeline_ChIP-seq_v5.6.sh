...
echo "==============================" >> $summary
echo "" >> $summary
echo "ChIP-Seq pipeline version 5.6" >> $summary
...
do
    ...
    case "${file##*.}" in
        ...
        bam)
            ...
            java -jar $pathPicard SamToFastq I=$file FASTQ=$outputFastq
            gzip $outputFastq
